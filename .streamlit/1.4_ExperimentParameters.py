...
with col3:
    ...
    st.session_state["t_off"] = st.number_input("t_off", value = st.session_state.get("t_off", defaults.get("t_off", None)))
    st.session_state["alpha"] = float(st.text_input("alpha", value = st.session_state.get("alpha", defaults.get("alpha", None))))
